...
<input type="text"  name="datepickerrangestart-<?=$sarahCroche['id']?>" class="text-dark" id="datepickerrangestart" value="">
<input type="text"  name="datepickerrangeend-<?=$sarahCroche['id']?>" class="text-dark" id="datepickerrangeend">
